...
\end{figure}
	...
	Do stworzenia interfejsu użytkownika została wykorzystana platforma programistyczna Angular, która pozwala na tworzenie komponentów wielokrotnego użytku oraz hermetyzację logiki w postaci serwisów aplikacyjnych. Cechą charakterystyczną platformy jest natywne wykorzystanie języka TypeScript.
